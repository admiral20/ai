...
function __VLS_template() {
    ...
    __VLS_styleScopedClasses['not-found'];
    __VLS_styleScopedClasses['not-found'];
    __VLS_styleScopedClasses['home-link'];
    __VLS_styleScopedClasses['home-link'];
    ...
    // @ts-ignore
    const __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0({ to: ("/"), ...{ class: ("home-link") }, }));
    const __VLS_2 = __VLS_1({ to: ("/"), ...{ class: ("home-link") }, }, ...__VLS_functionalComponentArgsRest(__VLS_1));
