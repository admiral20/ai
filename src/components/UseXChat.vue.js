...
function __VLS_template() {
    ...
    __VLS_styleScopedClasses['code-example'];
    // CSS variable injection 
    // CSS variable injection end 
    let __VLS_resolvedLocalAndGlobalComponents;
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("use-x-chat-demo") }, });
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)({});
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("code-example") }, });
    ...
    __VLS_styleScopedClasses['use-x-chat-demo'];
    __VLS_styleScopedClasses['demo-section'];
